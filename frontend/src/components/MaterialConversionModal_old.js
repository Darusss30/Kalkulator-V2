      ...
      >
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  {existingUnits.length > 0 
                    ? `${existingUnits.length} satuan tersedia`
                    : 'Tidak ada satuan di database'
                  }
                </p>
              </div>
            ...
            {/* Cement Specific Section */}
            {formData.material_type === 'powder' && (
              <div className="border-t pt-6">
                <div className="flex items-center mb-4">
                  <Beaker className="w-5 h-5 text-primary-600 mr-2" />
                  <h4 className="text-md font-semibold text-gray-900">Kalkulator Semen → Berdasarkan Data Riset</h4>
                </div>

                <div className="bg-blue-50 p-4 rounded-lg mb-4">
                  <h5 className="font-medium text-blue-900 mb-2">Data Riset Lokal:</h5>
                  <ul className="text-sm text-blue-800 space-y-1">
                    <li>• 1 sak semen = 40 kg (bukan 50 kg)</li>
                    <li>• Kebutuhan K-225: 0.0250 sak/m³</li>
                    <li>• Setara: 1.0 kg/m³</li>
                  </ul>
                </div>
                ...
                <div className="mt-4">
                  <button
                    type="button"
                    onClick={calculateCementConversion}
                    className="w-full flex items-center justify-center py-3 px-4 bg-blue-100 text-blue-700 border border-blue-300 rounded-lg hover:bg-blue-200 transition-colors"
                  >
                    <Beaker className="w-5 h-5 mr-2" />
                    <span>Gunakan Data Riset Semen</span>
                  </button>
                </div>
              </div>
            )}

            {/* Aggregate Specific Section (Pasir Japanan) */}
            {formData.material_type === 'aggregate' && (
              <div className="border-t pt-6">
                <div className="flex items-center mb-4">
                  <Package className="w-5 h-5 text-primary-600 mr-2" />
                  <h4 className="text-md font-semibold text-gray-900">Kalkulator Material Agregat</h4>
                </div>

                {(formData.name.toLowerCase().includes('pasir') && formData.name.toLowerCase().includes('japanan')) && (
                  <div>
                    <div className="bg-green-50 p-4 rounded-lg mb-4">
                      <h5 className="font-medium text-green-900 mb-2">Data Riset Pasir Japanan:</h5>
                      <ul className="text-sm text-green-800 space-y-1">
                        <li>• 1 truk = 7 m³</li>
                        <li>• Kebutuhan per m² granite: 0.0343 m³</li>
                        <li>• Untuk 1 m² granite butuh: 0.0049 truk</li>
                      </ul>
                    </div>
                    ...
                    <div className="mt-4">
                      <button
                        type="button"
                        onClick={calculatePasirJapananConversion}
                        className="w-full flex items-center justify-center py-3 px-4 bg-green-100 text-green-700 border border-green-300 rounded-lg hover:bg-green-200 transition-colors"
                      >
                        <Package className="w-5 h-5 mr-2" />
                        <span>Gunakan Data Riset Pasir Japanan</span>
                      </button>
                    </div>
                  </div>
                )}
            ...
            {formData.material_type === 'tile' && (
              <div className="border-t pt-6">
                <div className="flex items-center mb-4">
                  <Package className="w-5 h-5 text-primary-600 mr-2" />
                  <h4 className="text-md font-semibold text-gray-900">Khusus Keramik/Granit - Ukuran Dinamis</h4>
                </div>

                <div className="bg-yellow-50 p-4 rounded-lg mb-4">
                  <h5 className="font-medium text-yellow-900 mb-2">Contoh Data Riset:</h5>
                  <ul className="text-sm text-yellow-800 space-y-1">
                    <li>• 1 dus = 4 keping @ 60×60cm = 1.44 m²</li>
                    <li>• Jadi 1 m² = 0.6944 dus</li>
                    <li>• Sistem mendukung ukuran dinamis</li>
                  </ul>
                </div>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    title="Saran konversi umum berdasarkan nama material"
                  >
                    💡 Saran Umum
                  </button>
                </div>
