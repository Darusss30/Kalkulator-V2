// Default materials for beam calculator based on concrete quality and other parameters
export const getBeamDefaultMaterials = (concreteQuality, mainReinforcement, stirrupReinforcement) => {
  ...
  // Based on field data for beam formwork
  const bekistingMaterials = {
    triplek: { quantity: 1.200, unit: 'LEMBAR', name: 'TRIPLEK', price: 85000 },
    kayu_akasia_3x5: { quantity: 0.2500, unit: 'BENDEL', name: 'KAYU AKASIA 3X5', price: 170000 },
    kayu_akasia_4x6: { quantity: 0.3500, unit: 'BENDEL', name: 'KAYU AKASIA 4X6', price: 180000 }
  };
  ...
  const besiMaterials = {
    tulangan_utama: { 
      quantity: parseFloat((1 / getWeightPerLonjor(mainReinforcement)).toFixed(4)), // LONJOR per kg - 4 significant figures
      unit: 'LONJOR', 
      name: `BESI TULANGAN ${mainReinforcement}`, 
      price: reinforcementPrices[mainReinforcement] || 110000 
    },
    tulangan_sengkang: { 
      quantity: parseFloat((1 / getWeightPerLonjor(stirrupReinforcement)).toFixed(4)), // LONJOR per kg - 4 significant figures
      unit: 'LONJOR', 
      name: `BESI TULANGAN ${stirrupReinforcement}`, 
      price: reinforcementPrices[stirrupReinforcement] || 49000 
    },
