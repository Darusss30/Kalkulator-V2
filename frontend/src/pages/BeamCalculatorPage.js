...
const BeamCalculatorPage = () => {
  ...
  const handleCalculationComplete = (results) => {
    console.log('Beam calculation completed:', results);
  ...
  return (
    <>
      <Helmet>
        <title>Kalkulator Struktur - Kalkulator Konstruksi</title>
        <meta name="description" content="Kalkulator struktur untuk menghitung biaya konstruksi balok beton bertulang dengan konfigurasi tulangan dan campuran beton" />
      </Helmet>
              ...
              <div className="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                ...
                <div className="min-w-0 flex-1">
                  <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white truncate flex items-center">
                    ...
                    Kalkulator Struktur - {jobType?.name || 'Struktur'}
                  </h1>
                  <p className="text-primary-100 mt-1 text-sm sm:text-base lg:text-lg truncate">
                    {jobType ? `${jobType.description || jobType.name} - ${jobType.unit}` : 'Hitung biaya pekerjaan balok struktur beton bertulang'}
                  </p>
                </div>
              </div>
...
export default BeamCalculatorPage;
