  ...
  const handleMaterialFormSubmit = (e) => {
    ...
    if (selectedMaterial) {
      updateMaterialMutation.mutate({
        ...
        data: {
          ...materialFormData,
          price: materialFormData.price ? parseFloat(materialFormData.price) : 0
        }
      });
    }
  };
                ...
                <form onSubmit={handleMaterialFormSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setMaterialFormData(prev => ({ ...prev, price: e.target.value }))}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setMaterialFormData(prev => ({ ...prev, supplier: e.target.value }))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                  </div>
                  ...
                  <div className="flex items-center space-x-3 pt-4">
                    ...
                    >
                      ...
                      <span>
                        {updateMaterialMutation.isLoading ? 'Menyimpan...' : 'Simpan'}
                      </span>
                    </button>
                    <button
                      type="button"
